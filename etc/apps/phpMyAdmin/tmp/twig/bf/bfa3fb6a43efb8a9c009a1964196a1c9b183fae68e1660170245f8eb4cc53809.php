...
class __TwigTemplate_17ef47b1a0df8e0d026f71f61ecb4bff9c2fc4719630fadc4fc38b35882df357 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Your preferences will be saved for current session only. Storing them permanently requires %sphpMyAdmin configuration storage%s.");
    ...
    {
        return new Source("", "preferences/header.twig", "D:\\laragon\\etc\\apps\\phpMyAdmin\\templates\\preferences\\header.twig");
    }
}
